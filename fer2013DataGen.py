...
def save_data(x_train, y_train, fname="", folder="/home/dylan/Documents/Project/Machine_Learning/FE/"):
...
if __name__ == "__main__":
    ...
    x_public, y_public, emo_dict = load_data(sample_split=1.0,
                                           classes=emo,
                                           usage="PublicTest",
                                           verbose=True)
    print("Saving...")
    save_data(x_public, y_public, fname="_public")
    print("x public: ", x_public.shape)
    print("y public: ", y_public.shape)

    x_private, y_private, emo_dict = load_data(sample_split=1.0,
                                           classes=emo,
                                           usage="PrivateTest",
                                           verbose=True)
    print("Saving...")
    save_data(x_private, y_private, fname="_private")
    print("x private: ", x_private.shape)
    print("y private: ", y_private.shape)
    print("Done!")
